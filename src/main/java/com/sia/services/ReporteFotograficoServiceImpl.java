...
public class ReporteFotograficoServiceImpl implements ReporteFotograficoService {
	...
	public ReporteFotografico findById(Connection conn, BigInteger id) {
		...
		try {
			...
			for(int i = 0; i < result.length(); i++) {
				...
				rf.setS1Titulo(obj.getString("s1_division_region"));
				rf.setS1Titulo(obj.getString("s1_objetivo"));
				rf.setS1Titulo(obj.getString("s1_supervisor"));
				rf.setS1Titulo(obj.getString("s1_oficina"));
				rf.setS1Titulo(obj.getString("s2_planta_emergencia"));
				rf.setS1Titulo(obj.getString("s2_azotea_prop_compartida"));
				rf.setS1Titulo(obj.getString("s2_local_prop_rentado"));
				rf.setS1Titulo(obj.getString("s2_cuenta_estacionamiento"));
				rf.setS1Titulo(obj.getString("s2_num_cajas_ventanilla"));
				rf.setS1Titulo(obj.getString("s2_num_bancas_3_plazas"));
				rf.setS1Titulo(obj.getString("s2_num_bancas_2_plazas"));
				rf.setS1Titulo(obj.getString("s2_num_ejecutivos"));
				rf.setS1Titulo(obj.getString("s2_lugares_ejec_disponibles"));
				rf.setS1Titulo(obj.getString("s2_cuenta_banca_personal"));
				rf.setS1Titulo(obj.getString("s3_cuenta_senalizacion_prot_civ_completa"));
				rf.setS1Titulo(obj.getString("s3_num_extintores"));
				rf.setS1Titulo(obj.getString("s3_cuenta_llave_switch"));
				rf.setS1Titulo(obj.getString("s3_cuenta_contactores_alumbrado_aa"));
				rf.setS1Titulo(obj.getString("s3_num_atms"));
				rf.setS1Titulo(obj.getString("s3_num_pc"));
				rf.setS1Titulo(obj.getString("s3_cuenta_piso_alfombra"));
				rf.setS1Titulo(obj.getString("s4_capacidad_ups_marca"));
				rf.setS1Titulo(obj.getString("s4_cuenta_calefaccion"));
				rf.setS1Titulo(obj.getString("s4_garantia_impermeabilizacion"));
				rf.setS1Titulo(obj.getString("s4_facilidad_acceso_azotea"));
				rf.setS1Titulo(obj.getString("s4_cuenta_con_podio"));
				rf.setS1Titulo(obj.getString("s4_num_pantallas"));
	...
	public ReporteFotografico create(Connection conn, ReporteFotografico object) {
		...
		sql.append(", s2_local_prop_rentado, s2_cuenta_estacionamiento, s2_num_cajas_ventanilla, s2_num_bancas_3_plazas, s2_num_bancas_2_plazas, s2_num_ejecutivos, s2_lugares_ejec_disponibles, s2_cuenta_banca_personal ");
		...
		try {
			...
			ps.setString(11, object.getS2NumBancas3Plazas());
			ps.setString(12, object.getS2NumBancas2Plazas());			
			ps.setString(13, object.getS2NumEjecutivos());
			ps.setString(14, object.getS2LugaresEjecDisponibles());
			ps.setString(15, object.getS2CuentaBancaPersonal());
			ps.setString(16, object.getS3CuentaSenalizacionProtCivCompleta());
			ps.setString(17, object.getS3NumExtintores());
			ps.setString(18, object.getS3CuentaLlaveSwitch());
			ps.setString(19, object.getS3CuentaContactoresAlumbradoAA());
			ps.setString(20, object.getS3NumAtms());
			ps.setString(21, object.getS3NumPc());
			ps.setString(22, object.getS3CuentaPisoAlfombra());
			ps.setString(23, object.getS4CapacidadUpsMarca());
			ps.setString(24, object.getS4CuentaCalefaccion());
			ps.setString(25, object.getS4GarantiaImpermeabilizacion());
			ps.setString(26, object.getS4FacilidadAccesoAzotea());
			ps.setString(27, object.getS4CuentaConPodio());
			ps.setString(28, object.getS4NumPantallas());
